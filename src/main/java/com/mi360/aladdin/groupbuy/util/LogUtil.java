package com.mi360.aladdin.groupbuy.util;
...
public class LogUtil {
	...
	public static void logInput(String serviceName,String methodName,String requestID,Object... params){
		...
		if(logger.isInfoEnabled()){
			try {
				logger.info("本机ip:"+InetAddress.getLocalHost().getHostAddress()+" 创建时间:"+new Date().toLocaleString()+" 服务名称:"+serviceName+" 请求ID: "+ requestID +" 方法名:"+methodName+" 输入参数: "+paramStr);
